...
urlpatterns = patterns('invoicer.views',
    ...
    url(r'invoices/(?P<year>[\d]+)/(?P<number>[\d]+)/edit$', 'edit_invoice', name="edit_invoice"),
    url(r'invoices/(?P<year>[\d]+)/(?P<number>[\d]+)/add_line$', 'add_line', name="add_line"),
    url(r'invoices/(?P<year>[\d]+)/(?P<number>[\d]+)/delete_lines$', 'delete_lines', name="delete_lines"),
    url(r'invoices/(?P<year>[\d]+)/(?P<number>[\d]+)/$', 'view_invoice', name="invoice"),
