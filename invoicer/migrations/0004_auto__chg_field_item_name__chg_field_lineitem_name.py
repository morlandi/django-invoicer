...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('invoicer_item', 'name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'LineItem.name'
        db.alter_column('invoicer_lineitem', 'name', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Item.name'
        db.alter_column('invoicer_item', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'LineItem.name'
        db.alter_column('invoicer_lineitem', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))
