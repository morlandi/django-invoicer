...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.company'
        db.add_column('invoicer_client', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['invoicer.Company']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.company'
        db.delete_column('invoicer_client', 'company_id')
