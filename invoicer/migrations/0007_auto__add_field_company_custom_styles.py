...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.custom_styles'
        db.add_column('invoicer_company', 'custom_styles', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Company.custom_styles'
        db.delete_column('invoicer_company', 'custom_styles')
