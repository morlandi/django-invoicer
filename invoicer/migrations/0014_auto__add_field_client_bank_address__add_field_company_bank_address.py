...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Client.bank_address'
        db.add_column('invoicer_client', 'bank_address', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Company.bank_address'
        db.add_column('invoicer_company', 'bank_address', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Client.bank_address'
        db.delete_column('invoicer_client', 'bank_address')

        # Deleting field 'Company.bank_address'
        db.delete_column('invoicer_company', 'bank_address')
