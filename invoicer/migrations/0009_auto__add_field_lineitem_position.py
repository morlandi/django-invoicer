...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LineItem.position'
        db.add_column('invoicer_lineitem', 'position', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LineItem.position'
        db.delete_column('invoicer_lineitem', 'position')
