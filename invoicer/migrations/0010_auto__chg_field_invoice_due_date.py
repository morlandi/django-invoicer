...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invoice.due_date'
        db.alter_column('invoicer_invoice', 'due_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Invoice.due_date'
        db.alter_column('invoicer_invoice', 'due_date', self.gf('django.db.models.fields.DateField')())
