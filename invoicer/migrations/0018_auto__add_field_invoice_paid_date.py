...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.paid_date'
        db.add_column('invoicer_invoice', 'paid_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.paid_date'
        db.delete_column('invoicer_invoice', 'paid_date')
