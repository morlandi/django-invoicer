...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.serial'
        db.add_column('invoicer_invoice', 'serial', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=60, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.serial'
        db.delete_column('invoicer_invoice', 'serial')
    ...
    models = {
        ...
        'invoicer.invoice': {
            ...
            'serial': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '60', 'blank': 'True'}),
