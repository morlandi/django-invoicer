...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Client', fields ['vat_id']
        db.create_unique('invoicer_client', ['vat_id'])

        # Adding unique constraint on 'Client', fields ['name']
        db.create_unique('invoicer_client', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Client', fields ['name']
        db.delete_unique('invoicer_client', ['name'])

        # Removing unique constraint on 'Client', fields ['vat_id']
        db.delete_unique('invoicer_client', ['vat_id'])
    ...
    models = {
        'invoicer.client': {
            ...
            'vat_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32'})
        },
        'invoicer.company': {
