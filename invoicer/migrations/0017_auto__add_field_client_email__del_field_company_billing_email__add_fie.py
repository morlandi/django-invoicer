...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Company.billing_email'
        db.delete_column('invoicer_company', 'billing_email')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Company.billing_email'
        db.add_column('invoicer_company', 'billing_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=80, blank=True), keep_default=False)
