...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.net_total'
        db.add_column('invoicer_invoice', 'net_total', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=7, decimal_places=2), keep_default=False)

        # Adding field 'Invoice.gross_total'
        db.add_column('invoicer_invoice', 'gross_total', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=7, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.net_total'
        db.delete_column('invoicer_invoice', 'net_total')

        # Deleting field 'Invoice.gross_total'
        db.delete_column('invoicer_invoice', 'gross_total')
    ...
    models = {
        ...
        'invoicer.invoice': {
            ...
            'gross_total': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '7', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'net_total': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '7', 'decimal_places': '2'}),
