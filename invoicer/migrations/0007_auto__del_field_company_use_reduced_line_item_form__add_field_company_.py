...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.use_compact_invoice'
        db.add_column('invoicer_company', 'use_compact_invoice', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Company.use_compact_invoice'
        db.delete_column('invoicer_company', 'use_compact_invoice')
