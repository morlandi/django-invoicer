...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('invoicer_item', 'cost')

        # Deleting field 'LineItem.cost'
        db.delete_column('invoicer_lineitem', 'cost')


    def backwards(self, orm):
        
        # Adding field 'Item.cost'
        db.add_column('invoicer_item', 'cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'LineItem.cost'
        db.add_column('invoicer_lineitem', 'cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True), keep_default=False)
