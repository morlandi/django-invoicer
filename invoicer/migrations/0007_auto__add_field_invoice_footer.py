...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.footer'
        db.add_column('invoicer_invoice', 'footer', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.footer'
        db.delete_column('invoicer_invoice', 'footer')
