...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Terms.company'
        db.add_column('invoicer_terms', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['invoicer.Company']), keep_default=False)

        # Adding field 'Item.company'
        db.add_column('invoicer_item', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['invoicer.Company']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Terms.company'
        db.delete_column('invoicer_terms', 'company_id')

        # Deleting field 'Item.company'
        db.delete_column('invoicer_item', 'company_id')
