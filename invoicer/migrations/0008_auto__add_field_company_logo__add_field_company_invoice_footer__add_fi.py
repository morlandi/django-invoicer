...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('invoicer_company', 'logo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding field 'Company.invoice_footer'
        db.add_column('invoicer_company', 'invoice_footer', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('invoicer_company', 'logo')

        # Deleting field 'Company.invoice_footer'
        db.delete_column('invoicer_company', 'invoice_footer')
